...
<link rel="stylesheet" type="text/css"
	href="../../resources/css/prettify.css"></link>
<link rel="stylesheet" type="text/css"
	href="../../resources/css/bootstrap-wysihtml5.css"></link>
<script
...
<script
	src="http://evereq.github.io/bootstrap-wysihtml5/lib/js/highlight/highlight.pack.js"></script>
...
<script type="text/javascript"
	src="../../resources/js/lib/highlight.pack.js"></script>
...
<body>
	<div class="container" align="center">
		<div class="bs-docs-section clearfix">
			<div class="row">
				<div class="col-lg-12">
					...
					<div>
						<a href="/turkninja/users/${developer.username }"> << Ana
							Sayfaya Dön</a>
					</div>
		...
		<div class="row">
			...
			<div class="col-lg-8">
				<h4>Açıklama</h4>
				<p>
					Kod yazmak için önce editörden html tag'ini seçin ve ardından <b>&lt;pre&gt;&lt;code
						&gt;kod örneği&lt;/code&gt;&lt;/pre&gt;</b> şeklinde yazın
				</p>
				<form:form action="newArticle" method="post" commandName="article">
					<div class="hero-unit" style="margin-top: 40px">
						<h1 style="font-size: 58px">Yeni Makale</h1>
						<div>
							<h3>Başlık</h3>
							<form:input type="text" path="header" />
						</div>
						<hr />
						<div>
							<h3>Kategori</h3>
							<form:select id="category" path="category.name">
						...
						<form:textarea class="textarea" placeholder="Enter text ..."
							path="content" style="width: 810px; height: 350px"></form:textarea>
	...
	<script>
		$('.textarea').wysihtml5(
				{
					"stylesheets" : [ "../../resources/css/wysiwyg-color.css",
